...
public class Table {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Game2 game = new Game2(3,5,1,1,3,9,9);
        boolean bool = true;
        while(bool){
            game.stream();
...
class Game2{
    ...
    public Game2(int x, int y, int x1, int y1, int range,int yn, int xn){
        this.hero[0] = x;
        this.hero[1] = y;
        this.enemy[0] = x1;
        this.enemy[1] = y1;
    ...
    void stream(){
        ...
        while (y1<yn+1){
            ...
            for(int x1 = 1; x1 < xn+1; x1++){
                System.out.format( "%5s |" , color.isColor(x1,y1));
            }
